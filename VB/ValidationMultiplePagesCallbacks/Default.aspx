...
<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Editors_Validation_MultiplePages_Default" %>
<%@ Register Assembly="DevExpress.Web.v13.1" Namespace="DevExpress.Web" TagPrefix="dxm" %>
<%@ Register Assembly="DevExpress.Web.v13.1" Namespace="DevExpress.Web" TagPrefix="dxp" %>
<%@ Register Assembly="DevExpress.Web.v13.1" Namespace="DevExpress.Web" TagPrefix="dxw" %>
<%@ Register Assembly="DevExpress.Web.v13.1" Namespace="DevExpress.Web" TagPrefix="dxpgc" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
		...
		function OnPageControlEndCallback(s, e) {
			if(pageIndexToValidateOnPageControlEndCallback > -1) {
				ValidatePage(pageIndexToValidateOnPageControlEndCallback);
				pageIndexToValidateOnPageControlEndCallback = -1;
			}
		}
		...
		function SetActiveTab(activeTabIndex) {
			PageControl.SetActiveTab(activeTabIndex);
		}
		...
		function OnSumbitButtonClick(s, e) {
			...
			for(var i = 0; i < tabPageCount; i++) {
				if(!pageVisitedFlags[i]) {
					pageIndexToValidateOnPageControlEndCallback = i;
	...
	<form id="form1" runat="server">
		<div>
			<dxp:ASPxPanel ID="pnlDefaultButtonOwner" runat="server" Width="200px" DefaultButton="btnSubmit">
				<PanelCollection>
					<dxp:PanelContent>
						<dxpgc:ASPxPageControl ID="pgcPageControl" runat="server" ClientInstanceName="PageControl" Width="550px" Height="130px" EnableCallBacks="True">
							<ClientSideEvents
								Init="OnPageControlInit"
								ActiveTabChanged="OnPageControlActiveTabChanged"
								EndCallback="OnPageControlEndCallback" />
							<TabPages>
				...
				<tr>
					<td>
						<table>
							<tr>
								<td>
									<dxe:ASPxButton ID="btnPrev" runat="server" Text="Prev" AutoPostBack="False" 
